...
public class ArticleController {
	...
	// public String getArticleIdsByStatusAndSourceOrderByPublishatList1(
	// HttpServletRequest request, HttpServletResponse response,
	// ModelMap model, Long status, String source) throws Exception {
	//
	// log.info("/web/article  to /article/view/ArticleList");
	...
	// public String getArticleIdsBySourceOrderByPublishatList2(
	// HttpServletRequest request, HttpServletResponse response,
	// ModelMap model, String source) throws Exception {
	//
	// log.info("/web/Article  to /Article/view/ArticleList");
	//
	// return "/admin/Article/view/ArticleList";
	...
	// public String getArticleIdsByTypeOrderByPublishatList3(
	// HttpServletRequest request, HttpServletResponse response,
	// ModelMap model, Integer type) throws Exception {
	//
	// log.info("/web/Article  to /Article/view/ArticleList");
	//
	// return "/admin/Article/view/ArticleList";
	...
	// public String getArticleIdsByStatusAndSourceOrderByPublishatJsonList(
	// HttpServletRequest request, HttpServletResponse response,
	// ModelMap model, Integer page, Integer size, Integer status,
	...
	// try {
	//
	// List<Long> ids = articleService
	// .getArticleIdsByStatusAndSourceOrderByPublishat(status,
	// source, start, size);
	...
	// .countArticleIdsByStatusAndSourceOrderByPublishat(status,
	// source);
	...
	// public String getArticleIdsBySourceOrderByPublishatJsonList(
	// HttpServletRequest request, HttpServletResponse response,
	// ModelMap model, Integer page, Integer size, String source)
	// throws Exception {
	//
	// if (page == null) {
	// page = 1;
	...
	//
	// List<Long> ids = articleService
	// .getArticleIdsBySourceOrderByPublishat(source, start, size);
	...
	// RequestMethod.GET)
	// public String getArticleIdsByTypeOrderByPublishatJsonList(
	// HttpServletRequest request, HttpServletResponse response,
	...
	//
	// List<Long> ids = articleService
	// .getArticleIdsByTypeAndStatusOrderByPublishat(type,
	...
	private Integer getMaxSort() throws ServiceException, ServiceDaoException {
		...
		List<Long> maxs = this.articleService.getArticleIdsOrderBySort(0,
				Integer.MAX_VALUE);
		Integer max = 0;
