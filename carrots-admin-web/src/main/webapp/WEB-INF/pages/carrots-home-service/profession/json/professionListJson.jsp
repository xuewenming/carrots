		...
		<c:forEach items="${professionList}" var="profession">
			<json:object>
				...
				<json:property name="compensation"
					value="${profession.compensation}"></json:property>
				...
				<json:property name="responsibility"
					value="${profession.responsibility}"></json:property>
...
<%-- 				<c:forEach items="${profession.professionTagsList}" var="professionTags"> --%>
<%-- 					<json:object> --%>
